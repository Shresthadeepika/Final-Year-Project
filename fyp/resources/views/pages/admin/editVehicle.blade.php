                ...
                <div class="container" style="align-content=center;">
                    ...
                    <form method="POST" action="{{ route('admin.vehicle.update',$info->vehicle_id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="company" type="text" class="form-control @error('company') is-invalid @enderror" name="company" value="{{$info->company}}" required autocomplete="company" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="model" type="model" class="form-control @error('model') is-invalid @enderror" name="model" value="{{$info->model }}" required autocomplete="model">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="license" type="text" class="form-control @error('license') is-invalid @enderror" name="license" value="{{ $info->license }}" required autocomplete="license">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $info->price_per_day }}" required autocomplete="price">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <a href="{{route('admin.show.vehicle')}}" class="btn btn-danger">
                                    Cancel
                                </a>
                            </div>
                        </div>
