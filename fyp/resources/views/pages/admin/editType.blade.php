            ...
            @endif
                    <form method="POST" action="{{ route('admin.type.update',$type->type_id)}}" enctype="multipart/form-data"> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="num_of_seats" type="text" class="form-control @error('num_of_seats') is-invalid @enderror" name="num_of_seats" value="{{ $type->num_of_seats }}" required autocomplete="num_of_seats">
